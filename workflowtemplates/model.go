...
// Tags are pointers so an explicit empty list is sent as [] (omitempty only drops a nil
// pointer); a nil pointer leaves the field out and core applies its default.
