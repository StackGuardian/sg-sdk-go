...
type Workflow struct {
	...
	WfStepsConfig               *core.Optional[[]*sgsdkgo.WfStepsConfig]                              `json:"WfStepsConfig,omitempty" url:"-"`
	...
	EnvironmentVariables        *core.Optional[[]*sgsdkgo.EnvVars]                                    `json:"EnvironmentVariables,omitempty" url:"-"`
	DeploymentPlatformConfig    *core.Optional[[]*workflowtemplaterevisions.DeploymentPlatformConfig] `json:"DeploymentPlatformConfig,omitempty" url:"-"`
	VcsConfig                   *sgsdkgo.VcsConfig                                                    `json:"VCSConfig,omitempty" url:"-"`
	VcsTriggers                 *sgsdkgo.VcsTriggers                                                  `json:"VCSTriggers,omitempty" url:"-"`
	UserSchedules               *core.Optional[[]*sgsdkgo.UserSchedules]                              `json:"UserSchedules,omitempty" url:"-"`
